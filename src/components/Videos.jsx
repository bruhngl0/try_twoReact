  ...
  return (
    ...
    <Stack direction={['column' , 'row']} h={'100vh'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
            ...
            <Text>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex velit voluptatibus eius quae ratione ipsa, error exercitationem provident quas blanditiis inventore sequi recusandae deleniti vero aspernatur! Dignissimos incidunt deserunt repudiandae.
                a specified number of words, sentences, or paragraphs. Simply search for "Lorem ipsum generator" and choose one of the many options available.
